...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-graph-019-negami-s-conjecture-5d2de4a5-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GRAPH-019"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-graph-019-negami-s-conjecture-5d2de4a5-v1",
      "problem_contract_sha256": "4e645db3a84c51d343f00e4a16a99841db120b45dfa38dce23c2e7c9aa706ffc",
      "problem_id": "problem:um-graph-019-negami-s-conjecture-5d2de4a5",
      "route_id": "route:um-graph-019-negami-s-conjecture-5d2de4a5-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-graph-019-negami-s-conjecture-5d2de4a5-source-fidelity-01",
      "graph_id": "graph:um-graph-019-negami-s-conjecture-5d2de4a5-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-graph-019-negami-s-conjecture-5d2de4a5-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-graph-019-negami-s-conjecture-5d2de4a5-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does every graph with a planar cover have a projective-plane embedding?"
          },
          "statement_sha256": "6fd41dd7ff314b32e40e169d2c8a86780969909bd143c6cf9a302c9cd8becf60"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-graph-019-negami-s-conjecture-5d2de4a5-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-graph-019-negami-s-conjecture-5d2de4a5-root",
      "route_id": "route:um-graph-019-negami-s-conjecture-5d2de4a5-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-graph-019-9bca13306cbf",
        "url": "https://www.unsolvedmath.com/problems/GRAPH-019"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
